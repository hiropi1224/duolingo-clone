  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-bold uppercase tracking-wide ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        secondary:
          "border-2 border-b-4 border-green-600 bg-green-500 text-primary-foreground hover:bg-green-500/90 active:border-b-0",
        secondaryOutline: "bg-white text-green-500 hover:bg-slate-100",
        danger:
          "border-2 border-b-4 border-rose-600 bg-rose-500 text-primary-foreground hover:bg-rose-500/90 active:border-b-0",
        dangerOutline: "bg-white text-rose-500 hover:bg-slate-100",
        super:
          "border-2 border-b-4 border-indigo-600 bg-indigo-500 text-primary-foreground hover:bg-indigo-500/90 active:border-b-0",
